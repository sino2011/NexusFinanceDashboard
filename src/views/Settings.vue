<script setup>
    ...
    const sendData = async() => {
        try{
            const response = await axios.post('http://localhost:5000/settings', extraData.value)
    ...
    <div class="main-container" :class="{shifted: isVisible}">
            ...
            <div class="counters">
                <div class="salaryCard">
                    <div class="top">
                        ...
                        <span class="value-display">{{ formatCurrency(extraData.monthly_contributed) }}</span>
                    </div>
                    <div class="mid">
                        <input v-model.number="extraData.monthly_contributed" type="range" min="500" max="7500" step="100">
                    </div>
                    <div class="bot">
                        <p>$500</p>
                ...
                <div class="salaryCard">
                    <div class="top">
                        ...
                        <span class="value-display">{{ formatCurrency(extraData.debt_contributions) }}</span>
                    </div>
                    <div class="mid">
                        <input v-model.number="extraData.debt_contributions" type="range" min="500" max="7500" step="100">
                    </div>
                    <div class="bot">
                        <p>$500</p>
                ...
                <div class="salaryCard">
                    <div class="top">
                        ...
                        <span class="value-display">{{ formatCurrency(extraData.emergency_contribution) }}</span>
                    </div>
                    <div class="mid">
                        <input v-model.number="extraData.emergency_contribution" type="range" min="500" max="7500" step="100">
                    </div>
                    <div class="bot">
                        <p>$500</p>
        ...
        <div class="subs">
            ...
            <div class="inputsContainer">
                <div class="inputs">
                    <input v-model="extraData.subscription_name" type="text" placeholder="Subscription Name">
                    <input v-model="extraData.subscription_price" type="text" placeholder="Price">
                    <input v-model="extraData.subscription_status" type="text" placeholder="Status">
        ...
        <div class="subs">
            ...
            <div class="inputsContainer2">
                <div class="inputs">
                    <input v-model="extraData.transaction_name" type="text" placeholder="Transaction Name">
                    <input v-model="extraData.transaction_price" type="text" placeholder="Value">
                    <input v-model="extraData.transaction_date" type="date" placeholder="Date">
...
<style scoped>
    ...
    /* ==========================================================================
       CARDS (THE FIX IS HERE: No hard values or negative margins)
       ========================================================================== */
    .countersContainer {
        display: flex;
    ...
    /* ==========================================================================
       INPUT FORM FIELDS
       ========================================================================== */
    .inputsContainer, .inputsContainer2 {
        display: flex;
        justify-content: center;
        width: 100%;
        margin-bottom: 40px;
    ...
    @media (max-width: 1024px) {
        .main-container, .main-container.shifted {
            margin-left: 0;
            width: 100%;
            max-width: 100vw;
            padding: 20px;
    ...
    @media (max-width: 768px) {
        ...
        .a {
            /* font-size: 1.75rem; Larger display fonts for mobile navigation */
            margin: 0;
            padding: 0;
