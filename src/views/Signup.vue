  ...
  <div class="personal">
    <div class="topRow">
      ...
      <p class="register">
        ...
        <a href="/NexusFinanceDashboard/#/">Login</a>
      </p>
    </div>
    ...
    <div class="countersContainer" ref="middleRowRef">
      ...
      <form @submit.prevent="submitData">
        <div
          class="counters"
          ref="targetElement"
          :class="{ 'animate-trigger': isMiddleRowIntersecting }"
        >
          <div class="salaryCard">
            ...
            <div class="mid">
              <input
                v-model.number="income1"
                @input="formData.annual_income = income1"
                type="range"
                min="20000"
                max="500000"
                step="1000"
          ...
          <div class="salaryCard">
            ...
            <div class="mid">
              <input
                v-model.number="income2"
                @input="formData.savings_target = income2"
                type="range"
                min="20000"
                max="500000"
                step="1000"
          ...
          <div class="salaryCard">
            ...
            <div class="mid">
              <input
                ...
                @input="formData.timeline = timeline"
                type="range"
                min="3"
                max="120"
                step="1"
    ...
    <div class="reviews">
      ...
      <div
        ...
        ref="tableRowRef"
        :class="{ 'animate-trigger2': isTableRowIntersecting }"
      >
        <div class="revCard1">
          <h3>$14,400 saved in 18 months</h3>
          <span
            >John T.
            <span class="disc">— Software Engineer, Chicago</span></span
          >
          <p class="bordbot">
            Started with $0 emergency fund. Automated $800/month into a HYSA.
            Hit 6-month runway by month 14 — four months ahead of projection.
          </p>
          <div class="botCard">
            <div class="botleft">
              <p class="semi">$800</p>
        ...
        <div class="revCard2">
          ...
          <span
            >Priya & Daniel K.
            <span class="disc"> — Dual-income couple, Austin</span></span
          >
          <p class="bordbot">
            Two accounts, one goal. Used sinking fund rules to coordinate
            contributions. Currently 78.7% to target — on track for Q3 2026
            close.
          </p>
          <div class="botCard">
            <div class="botleft">
        ...
        <div class="revCard3">
          ...
          <span
            >Sarah O.
            <span class="disc">— Marketing Director, Seattle</span></span
          >
          <p class="bordbot">
            Opened a 529 the month her daughter was born. Conservative strategy
            at 12% savings rate. Projected balance at age 18: $312,000 with 7%
            market return.
          </p>
          <div class="botCard">
            <div class="botleft">
...
.revCard1 span:only-child,
.revCard2 span:only-child,
.revCard3 span:only-child {
  color: rgb(163, 163, 181);
  font-size: 0.75rem;
  line-height: 1rem;
  font-family: Manrope, sans-serif;
...
.animate-trigger {
  animation: SideEnter 1.9s ease-in-out forwards;
}

.animate-trigger2 {
  animation: fallIn 1.55s ease-in-out forwards;
}
